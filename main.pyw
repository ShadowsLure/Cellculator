...
bot = i.Client(intents=i.Intents.DEFAULT, send_command_tracebacks=False)
...
async def chlevels(ctx: i.SlashContext, value:int, channel:i.ChannelType.GUILD_TEXT = None):
...
bot.start('MTA3MDMwMTMzNDUxNzA1NTUxOA.GBwY0z.4qijJ0VRxdqRd4WsGklVnvjMuOgvKun-4NlwPQ')
